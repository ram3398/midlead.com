...
const errorMessageForEmptyFields = element => element.innerText = "You need to fill in this field"
...
function checkNameInput() {
  if (nameInput.value === '' || nameInput.value == null) {
    ...
    nameErrorMessage.innerText = "The name must contain at least 3 characters"
    addErrorClass(nameInputBox)
  } else if (nameInput.value.indexOf(" ") >= 0) {
    nameErrorMessage.innerText = "Invalid name, Please check the errors."
    addErrorClass(nameInputBox)
  } else {
...
function checkEmailInput() {
  if (emailInput.value === "" || emailInput.value == null) {
    ...
    emailErrorMessage.innerText = "Enter a valid email address"
    addErrorClass(emailInputBox)
  } else {
